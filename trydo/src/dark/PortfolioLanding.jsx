...
const SlideList = [
  {
    ...
    category: "Bienvenido a mi portafolio",
    description: "",
    buttonText: "",
    buttonLink: "",
  },
        ...
        <div className="slider-wrapper">
          ...
          {SlideList.map((value, index) => (
            <div
              ...
              key={index}
              style={{backgroundImage: "linear-gradient(#0000001a, black),url(https://images.pexels.com/photos/6424583/pexels-photo-6424583.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)", backgroundSize: "cover", backgroundPosition: "center center"}}
            >
